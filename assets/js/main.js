!(function(e, t) {
    ...
    S.extend({
            ...
            map: function(e, t, n) {
                ...
                if (b(e))
                    ...
                    for (o in e) null != (i = t(e[o], o, n)) && r.push(i);
                return f.apply([], r);
            },
            guid: 1,
            proxy: function(e, t) {
                                        ...
                                        if (void 0 !== t.getElementById && C) {
                                            ...
                                            if (o) {
                                                if ((n = o.getAttributeNode("id")) && n.value === e)
                                                    return [o];
                                                for (i = t.getElementsByName(e), a = 0;
                                                    (o = i[a++]);)
                                                    if ((n = o.getAttributeNode("id")) && n.value === e)
                                                        return [o];
                                            }
            ...
            (f = oe.select =
                function(e, t, n, a) {
                    ...
                    if (((n = n || []), 1 === d.length)) {
                        ...
                        for (
                            i = X.needsContext.test(e) ? 0 : o.length; i-- && ((r = o[i]), !_.relative[(s = r.type)]);
    ...
    (z.prototype = {
        ...
        set: function(e, t, n) {
            ...
            if ("string" == typeof t) i[S.camelCase(t)] = n;
                ...
                for (a in t) i[S.camelCase(a)] = t[a];
            return i;
        },
        get: function(e, t) {
            return void 0 === t ?
    ...
    S.extend({
        ...
        S.fn.extend({
            ...
            promise: function(e, t) {
                ...
                for (
                    "string" != typeof e && ((t = e), (e = void 0)), e = e || "fx"; r--;
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(L) || [""]).length; c--;)
                    if (
                        ...
                        for (m in l) S.event.remove(e, m + t[c], n, a, !0);
    ...
    function Ye(e, t, n, a, i) {
        var o,
            r = 0;
        for (
            o = n === (a ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2
        )
    ...
    S.extend({
        ...
        S.each({
            ...
            (S.cssHooks[i + o] = {
                expand: function(e) {
                    for (
                        var t = 0, n = {}, a = "string" == typeof e ? e.split(" ") : [e]; t < 4; t++
                    )
    ...
    (S.Animation = S.extend(it, {
        ...
        tweener: function(e, t) {
            for (
                var n,
                    a = 0,
                    i = (e = S.isFunction(e) ? ((t = e), ["*"]) : e.match(L)).length; a < i; a++
            )
                (n = e[a]),
                ...
                return (
                    ...
                    this.each(function() {
                        ...
                        if (t) a[t] && a[t].stop && r(a[t]);
                            ...
                            for (t in a) a[t] && a[t].stop && Ze.test(t) && r(a[t]);
                        for (t = n.length; t--;)
                            n[t].elem !== this ||
                            (null != i && n[t].queue !== i) ||
        ...
        S.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, a, i = e.options, o = S.makeArray(t), r = i.length; r--;

                        )
                            ((a = i[r]).selected = -1 < S.inArray(S.valHooks.option.get(a), o)) && (n = !0);
            ...
            trigger: function(e, t, n, a) {
                ...
                if (
                    ...
                    if (!a && !d.noBubble && !S.isWindow(n)) {
                        for (
                            s = d.delegateType || p, pt.test(s + p) || (o = o.parentNode); o; o = o.parentNode
                        )
                            u.push(o), (r = o);
                        r === (n.ownerDocument || C) &&
                    ...
                    k = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (h) {
                                if (!n)
                                    for (n = {};
                                        (t = Ct.exec(p));) n[t[1].toLowerCase()] = t[2];
                                t = n[e.toLowerCase()];
                            }
    ...
    S.ajaxSetup({
        ...
        S.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent; e && "static" === S.css(e, "position");
...
(function(e) {
    ...
    (r.prototype.lazyLoad = function() {
        ...
        if (
            ...
            for (
                var i = n - 1, r = a, s = o.$slider.find(".slick-slide"), l = 0; l < o.options.slidesToScroll; l++
            )
    ...
    (r.prototype.setupInfinite = function() {
        ...
        if (
            ...
            for (
                n = !0 === a.options.centerMode ?
                a.options.slidesToShow + 1 :
                a.options.slidesToShow,
                e = a.slideCount; e > a.slideCount - n; e -= 1
            )
                (t = e - 1),
                c(a.$slides[t])
                .clone(!0)
            ...
            return this.each(function() {
                ...
                f.on("scroll." + h.namespace, function() {
                    ...
                    if (
                        ...
                        (p = !1),
                        m++,
                        d.trigger("scrollLeave", {
                            position: t,
                            leaves: m
                        }),
                        null !== h.onLeave && h.onLeave(c, t),
                        o <= i ?
                        (d.trigger("scrollLeaveTop", {
                                position: t,
                                leaves: m
                            }),
                            null !== h.onLeaveTop && h.onLeaveTop(c, t)) :
                        a <= o &&
                        (d.trigger("scrollLeaveBottom", {
                                position: t,
                                leaves: m
                            }),
...
(function o(r, s, l) {
    ...
    for (
        var d = "function" == typeof require && require, e = 0; e < l.length; e++
    )
        c(l[e]);
    return c;
})({
            ...
            $("#submit_form").on("click", function() {
                $(".feedback_form_wrapper").addClass("hide_form_elements"),
                    ...
                    segmentEventTrack(getTrackingData("HDYHAU"), {
                        "how did you hear about us": "other" == targettedValue ?
                            "other " +
            ...
            getCookie("utmCookie") && (c.utms = JSON.stringify(getUTMData())),
                ...
                $.ajax({
                    ...
                    success: function(e) {
                        ...
                        var n = !1;
                        legacyAnalytics.identify(e.userid, {
                                email: s
                            }, {}, function() {
        ...
        $(window).scroll(function(e) {
            ...
            (window.onload = function() {
                ...
                "#pricing" === e || "#switching" === e ?
                    $("html, body").animate({
                            scrollTop: $('[data-section="section-' + e.substring(1) + '"]').offset()
                                .top - t,
                        },
                        1e3
                    ) :
                    ("#ios" !== e &&
                        ...
                        "#voice" !== e) ||
                    ($("html, body").animate({
                                scrollTop: $(".apps__card-outer_" + e.substring(1)).offset().top - t,
                            },
                            1e3
                        ),
...
function trackSubmitSearch(e) {
    ...
    0 < t.length &&
        segmentEventTrack("submit search", {
            form: "search",
            searchInput: t,
            formLocation: e.target.className || e.target.id || e.srcElement.name || "",
        });
}
    ...
    $("[data-notepad-install]").on("click", function() {
        ...
        legacyAnalytics.track(
                "Notepad install click", {
                    category: "Notepad install click",
                    label: "",
                    value: ""
                }, {},
                function() {
...
if (
    ...
    function findAndRemoveBlockedUrls() {
        for (
            var e = document.getElementsByTagName("script"), t = e.length, n = 0; n < t; n++
        )
